...
export const ParentFeatureSection: React.FC = () => {
  return (
    <section className="bg-gradient-to-br from-secondary-container/20 via-surface-container to-tertiary-container/10 dark:from-[#0F1626] dark:via-[#172038] dark:to-[#0F1626] rounded-3xl p-6 md:p-8 border border-outline-variant/30 dark:border-[#283556] shadow-xs mb-10 transition-colors duration-300">
      {/* Header Tag & Title */}
      <div className="mb-6">
        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-secondary-container text-on-secondary-container badge-eyebrow-label mb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
        ...
        <div className="lg:col-span-6 bg-surface-container-lowest/90 dark:bg-[#172038] backdrop-blur-xs rounded-2xl p-5 border border-outline-variant/30 dark:border-[#283556] shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between h-full">
