...
export const ForgotPasswordForm: React.FC<ForgotPasswordFormProps> = ({
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
      <div className="auth-form-field p-3.5 rounded-2xl bg-amber-950/40 border border-amber-500/30 text-xs flex flex-col gap-1">
      ...
      <div className="auth-form-field flex flex-col gap-1">
        <label className="text-[11px] font-bold text-zinc-300">Email tài khoản *</label>
        <div className="relative flex items-center">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 rounded-xl bg-zinc-950/80 border border-zinc-800 text-xs text-white placeholder-zinc-500 focus:outline-none focus:border-amber-500 transition-colors font-medium"
          />
        </div>
      </div>
