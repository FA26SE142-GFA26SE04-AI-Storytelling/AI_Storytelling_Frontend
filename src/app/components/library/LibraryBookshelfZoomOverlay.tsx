        ...
        <div className="bookshelf-left-drawer pointer-events-auto w-full lg:w-[420px] max-h-[50vh] lg:max-h-[75vh] flex flex-col rounded-3xl bg-tod-surface backdrop-blur-xl border border-tod-border shadow-[0_15px_40px_rgba(0,0,0,0.4)] text-tod-text overflow-hidden transition-colors duration-500">
          ...
          <div className="p-3 bg-tod-card border-b border-tod-border flex items-center gap-1 overflow-x-auto scrollbar-none">
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-xs font-bold whitespace-nowrap transition-all cursor-pointer ${selectedShelf === 'all'
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-xs font-bold whitespace-nowrap transition-all cursor-pointer flex items-center gap-1 ${selectedShelf === 'created'
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-xs font-bold whitespace-nowrap transition-all cursor-pointer flex items-center gap-1 ${selectedShelf === 'favorites'
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-xs font-bold whitespace-nowrap transition-all cursor-pointer flex items-center gap-1 ${selectedShelf === 'lullaby'
              ...
              filteredStories.map((story) => {
                ...
                return (
                  <div
                    ...
                    className={`bookshelf-story-card p-2.5 rounded-2xl border transition-all cursor-pointer flex items-center gap-3 ${isSelected
                  ...
                  >
                    ...
                    <button
                      ...
                      className={`p-2 rounded-xl transition-all cursor-pointer ${isFav
              ...
              <div className="relative w-full h-44 rounded-2xl overflow-hidden bg-tod-card shadow-inner group">
                ...
                <div className="absolute top-3 left-3 right-3 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={`p-2 rounded-xl backdrop-blur-md transition-all cursor-pointer ${favoritesMap[activeStory.id]
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-1">
            {DAY_STREAKS.map((stk, idx) => (
              <div
                key={idx}
                className={`bookshelf-streak-pill px-2 py-0.5 rounded-lg text-[10px] font-extrabold flex items-center gap-1 ${stk.isCompleted
