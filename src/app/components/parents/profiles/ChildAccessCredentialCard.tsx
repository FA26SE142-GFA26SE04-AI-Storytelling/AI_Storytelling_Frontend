...
export const ChildAccessCredentialCard: React.FC<ChildAccessCredentialCardProps> = ({
  ...
  return (
    <div className="laptop-tab-content-row p-4 rounded-2xl bg-gradient-to-br from-indigo-950/40 via-zinc-900/90 to-sky-950/40 border border-sky-500/30 shadow-lg space-y-3">
      {/* Header */}
      <div className="flex items-center justify-between pb-2 border-b border-zinc-800">
        ...
        <button
          ...
          className="px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-amber-500 via-orange-500 to-rose-500 hover:from-amber-400 hover:to-orange-400 text-zinc-950 font-black text-xs shadow-lg shadow-orange-500/25 flex items-center gap-1.5 transition-all hover:scale-105 cursor-pointer whitespace-nowrap"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
        ...
        <div className="p-2.5 rounded-xl bg-zinc-950/70 border border-zinc-800/80 flex items-center gap-3">
          <div
          ...
          <div className="flex flex-col min-w-0">
            <span className="text-[10px] text-zinc-400 font-medium">Linh vật của bé</span>
            <span className="text-xs font-bold text-white truncate">{avatar.name}</span>
          </div>
        </div>
