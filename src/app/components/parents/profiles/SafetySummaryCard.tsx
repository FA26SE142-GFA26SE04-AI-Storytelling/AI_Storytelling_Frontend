      ...
      {isLoadingDetail ? (
        ...
        <div className="space-y-3 text-xs">
          ...
          <div className="p-3 rounded-xl bg-zinc-950/70 border border-zinc-800 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className="text-[11px] text-zinc-400">Trạng thái an toàn:</span>
              <span className="px-2.5 py-0.5 rounded-full text-[11px] font-black border tracking-wide uppercase bg-emerald-950/80 border-emerald-500/60 text-emerald-300 flex items-center gap-1.5 shadow-sm shadow-emerald-500/20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
            ...
            <div className="sm:col-span-2 p-3 rounded-xl bg-zinc-950/80 border border-zinc-800/80 flex flex-col gap-2">
              ...
              {safetyPolicy.categories && safetyPolicy.categories.length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5">
                  {safetyPolicy.categories.map((cat, idx) => {
                    ...
                    return (
                      <div
                        key={idx}
                        className="p-2 rounded-xl bg-zinc-900/90 border border-zinc-800/80 flex items-center justify-between text-xs"
                      >
                ...
                <div className="p-2.5 rounded-xl bg-zinc-900/60 border border-zinc-800/60 text-xs text-zinc-400 flex items-center gap-2">
                  <span className="text-[11px] text-zinc-500">Không có danh mục hạn chế nào.</span>
                </div>
              )}
            </div>
          </div>
