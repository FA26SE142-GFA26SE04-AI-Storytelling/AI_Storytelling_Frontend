  ...
  return (
    ...
    >
      <div
        ...
        className="easy-login-card-modal pointer-events-auto w-full max-w-md rounded-3xl bg-zinc-950/95 border border-sky-500/30 shadow-[0_20px_50px_rgba(0,0,0,0.85)] p-5 sm:p-6 text-white space-y-4"
      >
        {/* Header */}
