  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-xl max-h-[90vh] rounded-3xl bg-zinc-950 border border-emerald-500/40 shadow-2xl flex flex-col overflow-hidden text-white animate-in zoom-in-95 duration-150 pointer-events-auto"
      >
        {/* Modal Header */}
        <div className="p-5 border-b border-zinc-800 bg-gradient-to-r from-emerald-950/70 via-zinc-900 to-zinc-950 flex items-center justify-between shrink-0">
        ...
        <form onSubmit={handleCreateChildSubmit} className="flex-1 overflow-y-auto p-5 space-y-4 dashboard-scrollbar">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="font-extrabold text-xs text-white">6 - 8 tuổi</span>
                  <span
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="font-extrabold text-xs text-white">9 - 12 tuổi</span>
                  <span
                    className={`text-[10px] font-bold px-1.5 py-0.5 rounded-md ${
                      newChildAgeBand === 'Age_9_12'
                        ? 'bg-emerald-500/20 text-emerald-300'
              ...
              <button
                ...
                className={`p-3 rounded-2xl border text-left flex flex-col gap-1.5 cursor-pointer transition-all ${
                  newChildScope === 'Personal'
                    ? 'bg-gradient-to-b from-sky-950/40 to-zinc-900 border-sky-500/80 shadow-md shadow-sky-500/10 ring-1 ring-sky-500/30'
                    : 'bg-zinc-900/60 hover:bg-zinc-900 border-zinc-800'
                }`}
              >
              ...
              <button
                ...
                className={`p-3 rounded-2xl border text-left flex flex-col gap-1.5 cursor-pointer transition-all ${
                  newChildScope === 'Organization'
                    ? 'bg-gradient-to-b from-purple-950/40 to-zinc-900 border-purple-500/80 shadow-md shadow-purple-500/10 ring-1 ring-purple-500/30'
                    : 'bg-zinc-900/60 hover:bg-zinc-900 border-zinc-800'
                }`}
              >
                <div className="flex items-center justify-between w-full">
          ...
          {newChildScope === 'Organization' && (
            <div className="p-3.5 rounded-2xl bg-zinc-900/80 border border-purple-500/30 flex flex-col gap-3">
              <div className="flex items-center justify-between">
              ...
              <div className="flex flex-col gap-1">
                ...
                {isLoadingOrgsAndClasses ? (
                  ...
                  <div className="p-2.5 rounded-xl bg-amber-950/40 border border-amber-500/30 text-amber-300 text-[11px] flex flex-col gap-1">
                    <span>
                    ...
                    {availableOrgs.map((org) => {
                      ...
                      return (
                        <option
                          ...
                          value={org.id}
                          disabled={!isActive}
                          className={!isActive ? 'text-zinc-500 bg-zinc-900' : 'text-white bg-zinc-950'}
                        >
              ...
              <div className="flex flex-col gap-1">
                ...
                {!newChildOrgId ? (
                  <div className="px-3 py-2 rounded-xl bg-zinc-950/60 border border-zinc-800 text-zinc-500 text-xs italic">
                  ...
                  (() => {
                    ...
                    if (orgClasses.length === 0) {
                      return (
                        <div className="p-2.5 rounded-xl bg-amber-950/30 border border-amber-500/30 text-amber-300 text-[11px]">
                    ...
                    return (
                      ...
                      >
                        ...
                        {orgClasses.map((cls) => (
                          <option key={cls.id} value={cls.id} className="text-white bg-zinc-950">
                            {cls.name}
                          </option>
                        ))}
                      </select>
          ...
          <div className="p-3 rounded-2xl bg-zinc-900/40 border border-emerald-500/20 text-zinc-300 text-[11px] flex items-start gap-2.5 leading-relaxed">
            <ShieldCheck className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
            <div>
              <strong className="text-emerald-300">Bảo mật thông tin của trẻ:</strong> Hệ thống chỉ sử dụng biệt danh và độ tuổi nhận thức để lựa chọn nội dung phù hợp. Chúng tôi luôn cam kết bảo vệ thông tin và quyền riêng tư của bé.
            </div>
          </div>
          ...
          <div className="flex items-center justify-end gap-2.5 pt-3 border-t border-zinc-800">
            <button
              ...
              className="px-4 py-2 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-zinc-300 text-xs font-semibold cursor-pointer transition-colors"
            >
              Hủy bỏ
            </button>
            <button
