...
export const InvitationDecisionCard: React.FC<InvitationDecisionCardProps> = ({
  ...
  return (
    <div className="space-y-4 text-xs animate-in fade-in duration-200">
      {/* Code Badge Card */}
      <div className="p-4 rounded-2xl bg-zinc-900/90 border border-indigo-500/30 flex flex-col gap-3">
        ...
        <div className="p-3 rounded-xl bg-black/60 border border-zinc-800 flex items-center justify-between gap-2">
          <div className="font-mono text-sm font-black text-sky-300 tracking-wider">
            {invitationCode}
          </div>
          <span className="px-2 py-0.5 rounded-md text-[10px] font-bold bg-sky-950 border border-sky-500/40 text-sky-300">
            Dùng 1 lần
          </span>
        </div>
      ...
      <div className="p-3.5 rounded-2xl bg-gradient-to-r from-emerald-950/40 to-sky-950/40 border border-emerald-500/30 flex items-start gap-2.5">
      ...
      {showRejectConfirm ? (
        <div className="p-3.5 rounded-2xl bg-rose-950/50 border border-rose-500/40 space-y-2 animate-in fade-in">
          ...
          <div className="flex items-center justify-end gap-2 pt-1">
            <button
              ...
              className="px-3 py-1.5 rounded-xl bg-zinc-900 border border-zinc-700 text-zinc-300 text-xs font-semibold cursor-pointer"
            >
              Quay lại
            </button>
            <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-2 border-t border-zinc-800">
          <button
            ...
            className="py-2.5 px-3 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-700 hover:border-rose-500/50 text-zinc-400 hover:text-rose-300 text-xs font-bold flex items-center justify-center gap-1.5 transition-colors cursor-pointer disabled:opacity-50"
          >
            <Ban className="w-3.5 h-3.5" />
