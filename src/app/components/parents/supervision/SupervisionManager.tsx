...
export const SupervisionManager: React.FC<SupervisionManagerProps> = ({
  ...
  return (
    <div className="space-y-4 text-tod-text">
      {/* Navigation Switcher: Single vs Bulk Enrollment */}
      <div className="flex flex-wrap items-center justify-between gap-2 p-1.5 rounded-2xl bg-tod-card border border-tod-border shadow-sm">
        <div className="flex items-center gap-1.5">
          ...
          >
            ...
            <span className="text-[10px] px-1.5 py-0.2 rounded bg-purple-500/15 text-purple-600 dark:text-purple-300 font-semibold border border-purple-500/30">
              Sắp ra mắt
            </span>
          </button>
        </div>

        <span className="text-[11px] text-tod-text-muted hidden sm:inline px-2">
      ...
      {/* Feedback Alerts */}
      {supervisionSuccessMsg && (
        <div className="p-3 rounded-xl bg-emerald-500/15 border border-emerald-500/40 text-emerald-700 dark:text-emerald-300 text-xs flex items-center gap-2 animate-in fade-in">
      ...
      {supervisionError && (
        <div className="p-3 rounded-xl bg-rose-500/15 border border-rose-500/40 text-rose-700 dark:text-rose-300 text-xs flex items-center gap-2 animate-in fade-in">
